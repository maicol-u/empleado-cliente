<template>
  <div class="container">
    ...
    <div class="m-2 col col-sm-6">
      ...
      <input type="text" name="" id="" v-model="min" placeholder="Salario minimo"
    ...
    <table class="table">
      ...
      <tbody>
        <tr v-for="employee in employees" :key="employee.id">
          ...
          <td>
            <router-link :to="'/empleado/' + employee.id" class="nav-link"> <button class="btn btn-primary">Ver</button>
            </router-link>
          </td>
        </tr>
      </tbody>
